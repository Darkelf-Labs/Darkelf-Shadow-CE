...
class StealthInterceptor(QWebEngineUrlRequestInterceptor):
    ...
    COMPATIBILITY_RESOURCE_ALLOW = {
        ...
        ("outlook.live.com", "office365.com"),
        ...
        # Outlook / Microsoft 365 core application resources.
        # Only Microsoft-owned app/auth families bypass the expensive general
        # filter scan; unrelated third-party ad/tracker hosts remain filtered.
        ("outlook.office365.com", "outlook.office365.com"),
        ("outlook.office365.com", "office365.com"),
        ("outlook.office365.com", "office.com"),
        ("outlook.office365.com", "office.net"),
        ("outlook.office365.com", "microsoft.com"),
        ("outlook.office365.com", "microsoftonline.com"),
        ("outlook.office365.com", "live.com"),
        ("outlook.office365.com", "msauth.net"),
        ("outlook.office365.com", "msftauth.net"),

        ("outlook.office.com", "outlook.office.com"),
        ("outlook.office.com", "office.com"),
        ("outlook.office.com", "office.net"),
        ("outlook.office.com", "microsoft.com"),
        ("outlook.office.com", "microsoftonline.com"),
        ("outlook.office.com", "live.com"),
        ("outlook.office.com", "msauth.net"),
        ("outlook.office.com", "msftauth.net"),
    ...
    def __init__(
        ...
        # Build the Qt resource-type lookup once. _detect_request_type() runs for
        # every intercepted request, so rebuilding this mapping there adds
        # unnecessary work on busy pages.
        self._resource_type_map: dict[object, str] = {}
        resource_type_pairs = [
        ...
        resource_type_enum = QWebEngineUrlRequestInfo.ResourceType
        for attr, name in resource_type_pairs:
            if hasattr(resource_type_enum, attr):
                self._resource_type_map[getattr(resource_type_enum, attr)] = name
    ...
    def interceptRequest(self, info):
        ...
        try:
            if self.engine and self.engine.should_block(
                ...
                req_type,
                req_host=host,
                first_party_host=fp_host,
                request_path=qurl.path(),
            ):
    ...
    def _detect_request_type(self, info) -> str | None:
        ...
        req_type = self._resource_type_map.get(rt)

        # Preserve the v7.0.7 MainFrame fallback exactly.
        if req_type is None and hasattr(
