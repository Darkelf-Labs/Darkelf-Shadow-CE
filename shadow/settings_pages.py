...
class QuantumPage(QWidget):
    ...
    def refresh(self):
        ...
        try:
            ...
            if "destroyed" in str(e).lower():
                self._set_unavailable("Destroyed")
            else:
                print(f"[Settings] Quantum runtime error: {e}")
            ...
            print(f"[Settings] Quantum refresh failed: {e}")
            self._set_unavailable("Unavailable")
            self.applyAccent()
            return
    ...
    def _set_unavailable(self, status="Unavailable"):
        ...
        self.integrity_badge.setText("Unavailable")
        self.session_badge.setText("Ended")
        self.generation_badge.setText("--")
        self.rekeys_badge.setText("--")
        self.requests_badge.setText("--")
        self.tabs_badge.setText("--")
...
class AboutPage(QWidget):
    ...
    def __init__(self, browser):
        ...
        version = SettingsChip("Version 7.0.10", accent)
