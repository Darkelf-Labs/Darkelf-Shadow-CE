...
def boot_done(splash, app, engine, ai):
    ...
    try:
        ...
        if IS_MAC_ARM64:
            # Darkelf Shadow 7.0.9 Apple Silicon.
            # Named profile required for native passkeys / Touch ID
            # with Darkelf's custom QtWebEngine.
            profile = QWebEngineProfile("Darkelf", app)
        else:
            # Preserve Darkelf Shadow 7.0.8 behavior on Windows/Linux
            # and other standard QtWebEngine builds.
