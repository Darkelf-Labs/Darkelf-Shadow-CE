...
class DarkelfMiniAISentinel:
    ...
    def __init__(self):
        ...
        self.intrusion_patterns = {
            ...
            # `onload=` is intentionally excluded here: modern CAPTCHA/API URLs
            # commonly use a benign ?onload=callback query parameter. DOM event
            # handler detection belongs in page/content inspection, not URL telemetry.
            "xss": ["<script", "javascript:", "onerror=", "eval("],
    ...
    def monitor_network(self, url, headers=None):
        ...
        regexes = [
            ...
            (r"(?:<script\b|javascript:|\bonerror\s*=)", "high"),
            (r"(?:\.\./|\.\.\\|%2e%2e)", "critical"),
