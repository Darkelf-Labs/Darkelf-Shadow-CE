...
class DarkelfInspector(QWidget):
    ...
    def _refresh_runtime(self):
        ...
        Updates Quantum and MiniAI dashboard values without
        continuously filling the Inspector console.
        """
        ...
        try:
            ...
            self.status_label.setText("Status: Quantum error")
            self.console.log(
        ...
        try:
            ...
            self.status_label.setText("Status: MiniAI error")
            self.console.log(
    ...
    def refresh_quantum(self):
        """
        Refresh the Darkelf Quantum dashboard.
        """

        pq = self._resolve_quantum()

        if not pq:
            self.quantum_pill.setText("QUANTUM: UNAVAILABLE")
        ...
        try:
            ...
            self.q_observed.setText(
                str(stats.get("observed", 0))
            )

            self.q_rekeys.setText(
                str(stats.get("rekeys", 0))
            )

            self.q_seed_age.setText(
                str(stats.get("seed_age", 0))
            )
